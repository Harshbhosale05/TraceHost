...
# Extend timeout settings for long API calls
GEMINI_API_TIMEOUT = 30  # 30 seconds timeout for Gemini API calls

# Increase timeout settings to handle longer API requests
DATA_UPLOAD_MAX_MEMORY_SIZE = 5242880  # 5MB
GEMINI_API_TIMEOUT = 30  # 30 seconds for Gemini API calls
